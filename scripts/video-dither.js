(function() {
    ...
    function createDitheredVideoElement(videoEl, options, existingWrapper) {
        ...
        var fragmentSource = [
            ...
            '  vec2 warp = u_velocity * pow(max(dist, 0.001), 0.82) * 0.26;',
    ...
    function createViewportDitherCanvas() {
        ...
        var fragmentSource = [
            ...
            '  float warpFalloff = pow(max(pinchedDist, 0.001), 0.82);',
            '  vec2 warp = u_velocity * warpFalloff * 0.26;',
            ...
            '    float shadowSpread = 20.0 * u_shadowStrength;',
